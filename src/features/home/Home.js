...
import {
  useLazyIsNewUserQuery,
  useSaveUserDataMutation,
} from "../../services/apiConfigUserProfile";
...
import { resetReport } from "../feedwater/activitymonitor/activityMonitorSlice";
...
function Home() {
  ...
  const decodeIDToken = (idToken) => {
    ...
    console.log(
      "------SSO disabled :- updating slice with static user info: ",
      newUserInfo
    );
  ...
  useEffect(() => {
    if (process.env.REACT_APP_ENABLE_APP_SCAN == "enabled") {
      ...
      const tokenResponse_testData = {
        access_token:
          "00D3D00000017Vm!AQMAQGlfgqfWybv9GgKZuqMOEwFgpsWEgkw0wy.k4SrcQqW8NGPd3yJMqNT08Pnfp2xhQ1TGs6aclxwnxkduyNgMu8UphByl",
        refresh_token:
          "5Aep861OeIX6GiNvi13sc2QFKhp7ekYqFlYpFzKEK6hG3U9PES3qwfsl68zcHDQ9_AjzAbe5QyonoGbk3zTE6Sy",
        sfdc_community_url:
          "https://tools-dupont--dtqa.sandbox.my.site.com/signin",
        ...
        id_token:
          "eyJraWQiOiIyNDYiLCJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..K_hncqt9QH6GU55YlHqyZ5rz6tupGn4I5KAJ7oJStyufLeIPa2fHgX3NxKoaUL3HBnf58SvjIubm-2KMjfa3yWt_IzER1iewRImWeBZEDbrRygxqU9O4sY-qYrLcUudNCI7PJri59Fl3do7TIRTulb8EddiG4_6p9AzQ2_gPFg_jGO3PiS7Q24HO3pnp4P9RqMEjV8rhFwIhZ8IIH_fjRriXaUJCdTTqx7ypp2oOypJhO2Y-4_QKamWuaDfG6JtxL8iwNBjL9LmxMoSUlq344MfR9Yrepe4jsMW4456-c_jeQXxqHrihVJpbwVuXQPMWdG4WPmP0M3zltOMe7xGI-D8pFk5_cShEagYSiMY8ZtXd92Cu_9OOn2HeUN9DBQ55empA24RvIzUeTIz0ES1Xwnjw7mJCv8k7yRaz7TwxZX3QXCuLT1oQIbTlof2Y7JGcmR6geSIRiDR80ZWVPtpN2YhhzQxDlzC69CjQuk5vR4QKO7aLyoJqCiTEn_51Mm8oJ5b0kRH8pE8_Z6VTLggfhQ9ihGYN6LKysdYLQ6EVYU1NM9ju6yKGt-7fq3HAvF6eUISpZu0ktZliuPsck457_lC-VXptwHsbNm9M5tVqIYo6Vx_Eoo0JHvyyBANDYkNTUKLAD2IFLpCyCWxs0lPk88-1dyJL91IxOpAPP-6LLPI",
      ...
      localStorage.setItem(
        "accessTokens",
        JSON.stringify(tokenResponse_testData)
      );
      decodeIDToken(tokenResponse_testData.id_token);
    } else {
      console.log("HOME - AppScan is disabled");
      if (
        localStorage.getItem("firstLoginChecked") == null ||
        localStorage.getItem("firstLoginChecked") != "true"
      ) {
        validateIsFirstLoggedIn();
      }
    }
    ...
    if (responseFirstLogin.status == "fulfilled") {
      if (responseFirstLogin.data.userID !== undefined) {
        ...
        sessionStorage.setItem(
          "userDetails",
          JSON.stringify(responseFirstLogin)
        );
        dispatch(updateUserInfo(userDetails));
        console.log(
          "responseFirstLogin?.data?.userID",
          responseFirstLogin?.data?.userID
        );
  ...
  const handleSaveUser = async () => {
    ...
    console.log(
      "userCustomAttributes.First_Name",
      userCustomAttributes.First_Name
    );
    console.log(
      "userCustomAttributes.UserEmail",
      userCustomAttributes.UserEmail
    );
    const payload = {
      ...userData,
  ...
  const validateIsFirstLoggedIn = () => {
    if (userCustomAttributes?.UserEmail) {
      ...
      if (sessionStorage.getItem("userLogedIn")=="true") {
        ...
        const userDetails = { ...userInfoSliceStore };
        let newData = JSON.parse(sessionStorage.getItem("userDetails"));
        userDetails.UserId = newData.data.userID;
        userDetails.lastLoggedIn = newData.data.lastLoginTime;
        dispatch(updateUserInfo(userDetails));
        ...
        <div className="home-section">
          <div
            style={{
              ...
              "--bgColor": `${showSideMenu ? "rgba(0,0,0,0.5)" : ""}`,
              zIndex: showSideMenu && !showMenuIcon ? "3" : "5",
            }}
            className={`side-menu ${
              showSideMenu && !showMenuIcon ? " hide" : " show"
            } ${showSideMenu ? "" : "normal"}`}
          >
            <SideMenu
              showSideMenu={showSideMenu}
          ...
          <div
            style={{
              width: `${showSideMenu ? "100%" : "81%"}`,
              marginLeft: `${showSideMenu ? "0px" : "auto"}`,
            }}
